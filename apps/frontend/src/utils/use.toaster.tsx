...
export const Toaster = () => {
  ...
  return (
    <div
      className={clsx(
        'animate-fadeDown rounded-[8px] gap-[18px] flex items-center overflow-hidden bg-toaster p-[16px] min-w-[319px] fixed start-[50%] z-[900] top-[32px] -translate-x-[50%] h-[56px]',
